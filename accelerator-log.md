...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=metaage-vmware&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=metaage-vmware&repo=tanzu-java-web-app'
